...
This powerup provides comprehensive, research-backed guidance for Azure DevOps architecture based on 2024-2025 best practices. It covers the complete lifecycle from initial provisioning through production operations, with emphasis on:
...
Invoke the powerup to see the interactive menu:
...
/azure-arch:provision

# Deploy an application
/azure-arch:deploy

# Setup CI/CD with GitHub Actions
/azure-arch:setup-cicd github
...
# Optimize costs
/azure-arch:optimize-costs

# Configure networking
/azure-arch:setup-network

# Design shared resources (multi-product infrastructure)
/azure-arch:shared-resources

# Scale infrastructure
/azure-arch:scale

# Setup dev/staging/prod environments
/azure-arch:environments
...
This powerup follows these core principles across all workflows:
...
## What Makes This Powerup Special
...
1. **Be specific**: Instead of `/azure-arch:provision`, try `/azure-arch:provision aks cluster for production`
2. **Provide context**: Mention your current setup, constraints, or requirements
3. **Ask follow-ups**: The powerup has deep knowledge - don't hesitate to ask for clarification
...
The powerup includes real pricing throughout:
...
This powerup is part of the [Claude Code Powerups](https://github.com/waelouf/claude-code-powerups) marketplace.
...
Start with: `/azure-architect` or jump directly to any workflow with the slash commands above.
