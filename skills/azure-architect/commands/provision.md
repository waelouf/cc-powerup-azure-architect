...
<invocation>
Execute the azure-architect powerup with context to immediately start the provision-infrastructure workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the provision-infrastructure workflow.
...
Do not show the powerup intake menu - go directly to provisioning workflow.
</instructions>
