...
<invocation>
Execute the azure-architect powerup with context to immediately start the implement-disaster-recovery workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the implement-disaster-recovery workflow.
...
Do not show the powerup intake menu - go directly to disaster recovery workflow.
</instructions>
