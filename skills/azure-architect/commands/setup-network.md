...
<invocation>
Execute the azure-architect powerup with context to immediately start the setup-networking workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the setup-networking workflow.
...
Do not show the powerup intake menu - go directly to networking workflow.
</instructions>
