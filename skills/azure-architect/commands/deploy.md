...
<invocation>
Execute the azure-architect powerup with context to immediately start the deploy-application workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the deploy-application workflow.
...
Do not show the powerup intake menu - go directly to deployment workflow.
</instructions>
