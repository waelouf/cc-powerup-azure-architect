---
name: azure-arch:shared-resources
...
<invocation>
Execute the azure-architect powerup with context to immediately start the design-shared-resources workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the design-shared-resources workflow.
...
Do not show the powerup intake menu - go directly to shared resources workflow.
</instructions>
