...
<invocation>
Execute the azure-architect powerup with context to immediately start the setup-cicd-pipeline workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the setup-cicd-pipeline workflow.
...
Do not show the powerup intake menu - go directly to CI/CD setup workflow.
</instructions>
