...
<invocation>
Execute the azure-architect powerup with context to immediately start the secure-infrastructure workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the secure-infrastructure workflow.
...
Do not show the powerup intake menu - go directly to security workflow.
</instructions>
