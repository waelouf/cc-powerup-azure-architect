---
name: azure-arch:optimize-costs
...
<invocation>
Execute the azure-architect powerup with context to immediately start the optimize-costs workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the optimize-costs workflow.
...
Do not show the powerup intake menu - go directly to cost optimization workflow.
</instructions>
