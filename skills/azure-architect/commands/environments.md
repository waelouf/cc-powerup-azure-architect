...
<invocation>
Execute the azure-architect powerup with context to immediately start the setup-environments workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the setup-environments workflow.
...
Do not show the powerup intake menu - go directly to environments setup workflow.
</instructions>
