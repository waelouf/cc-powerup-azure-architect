...
<invocation>
Execute the azure-architect powerup with context to immediately start the migrate-to-azure workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the migrate-to-azure workflow.
...
Do not show the powerup intake menu - go directly to migration workflow.
</instructions>
