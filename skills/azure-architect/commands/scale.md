...
<invocation>
Execute the azure-architect powerup with context to immediately start the scale-infrastructure workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the scale-infrastructure workflow.
...
Do not show the powerup intake menu - go directly to scaling workflow.
</instructions>
