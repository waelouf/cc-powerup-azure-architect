...
<invocation>
Execute the azure-architect powerup with context to immediately start the setup-monitoring workflow.
...
<instructions>
Load the azure-architect powerup and immediately execute the setup-monitoring workflow.
...
Do not show the powerup intake menu - go directly to monitoring setup workflow.
</instructions>
